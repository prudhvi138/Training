...
//		System.out.println(emp);
		...
		Employee employee1 = new Employee(105, "raju", "kolkota", 24, 90986576L, 878756.00);
		
		boolean status = employeeDAO.addEmployee(employee1);
	boolean status1 = employeeDAO.deleteEmployee(employee1);
//		
//		if(status)
//		{
